...
$_=@file_get_contents(($Q='https://www.harzsparkasse.de/de/home/onlinebanking/finanzstatus.html'));
...
#logged in
$_=@file_get_contents($Q,!1,stream_context_create(array('http'=>
array('max_redirects'=>0,'header'=>"Cookie: $J $I {$_[0]} $C\r\n"))));
#print_r($http_response_header);



#logout (get new J cookie, QS, form-vars)
preg_match("#JSESSIONID\=(.*?);#",implode($http_response_header),$J);$J=@$J[0];
preg_match("#\?sp:ac.*?\"#msi",$_,$f);$f=substr(@$f[0],0,-1);
...
@file_get_contents($Q.$f,!1,stream_context_create(array('http'=>
array('max_redirects'=>0,'method'=>'POST','header'=>"Cookie: $J $I $C\r\n",'content'=>"$x&$y&$z"))));
